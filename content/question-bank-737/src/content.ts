...
export const CONTENT_PATH = "./content/question-bank-737/content";
export const BUILD_PATH = "./apps/next-app/public/content/question-bank/737";

export const getAllQuestions = async (): Promise<QuestionTemplate[]> => {
