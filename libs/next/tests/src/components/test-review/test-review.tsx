...
import { TestReviewQuestion } from "./test-review-question";
...
const TestReviewComponent: FunctionComponent<Props> = ({
  testId,
  sx,
  component = "section",
}) => {
...
export const TestReview: FunctionComponent<Props> = (props) => (
  <NoSsr children={<TestReviewComponent {...props} />} />
);
