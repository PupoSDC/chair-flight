...
export const questionBankGetQuestionMock: AppRouterOutput["questionBank"]["getQuestion"] =
  {
    questionTemplate: {
      id: "Q000YBA1ON",
      ...
      variants: {
        ...
        BoFooFbr: {
          ...
          question:
            "Annex 14 to the convention on international civil aviation contains SARPS for:",
          options: [
            { id: "AMUIXTPNDI", text: "Aerodromes", correct: true, why: "" },
            { id: "AK07WZX0SD", text: "Security", correct: false, why: "" },
            {
              id: "AN6WCW0Z03",
              text: "None of the above",
              correct: false,
            ...
            { id: "AL4EQSB0K2", text: "Facilitation", correct: false, why: "" },
          ],
          annexes: [],
          externalIds: ["ATPLGS-622143", "AVEXAM-67778"],
          explanation: "",
