...
import type { Annex, Course, Doc, LearningObjective, QuestionTemplate, Subject } from "@cf/core/question-bank";
...
export const compileQuestionBank = async (
  ...
  await fs.writeFile(
    path.join(process.cwd(), path.join(outputFolder), "learning-objectives.json"),
