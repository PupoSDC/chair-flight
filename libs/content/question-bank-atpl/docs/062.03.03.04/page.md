---
learningObjectiveId: "062.03.03.04"
parentId: "062.03.03"
title: Errors, accuracy, limitations
---

```tsx eval
<LearningObjectives learningObjectiveId={"062.03.03.04"} />
```
...
<Option why="EM from a weather radar use a specific frequency and do not interfere with any other radar system in airport.">
  Radiation from the AWR can interfere with other radar services provided by the
  aerodrome (for example, PSR)
</Option>
