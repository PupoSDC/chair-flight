---
SyllabusReference: 031.01.02.02
Title:
...
1.  **031.01.02.02.01** -- Describe the relationship between CG position and
    aircraft performance.
2.  **031.01.02.02.02** -- Describe the effects of CG position on performance
    parameters (speeds, altitude, endurance and range).

|                 | ATPL(A) | CPL(A) | ATPL(H)/IR | ATPL(H)/VFR | CPL(H) | IR  | CBIR(A) |
| --------------- | ------- | ------ | ---------- | ----------- | ------ | --- | ------- |
| 031.01.02.02.01 | X       | X      | X          | X           | X      |     |         |
| 031.01.02.02.02 | X       | X      | X          | X           | X      |     |         |
