...
export const meta = {
  ...
  description: 'Our goal is to build an **Open Source**, **Free** and **Community driven** aviation question bank built by students for students.'
}
...
<a role="button" href="/questions" className="full-width">Explore questions</a>

export default ({ children }) => <ArticlePageLayout meta={meta}>{children}</ArticlePageLayout>